...
Purpose is measurement, not production. The question it answers is whether a
populated market is affordable: the shipped cast rigs are 3-5 MB each, so a
vendor cannot be a copy of one.
...
box('Vendor head', (head_head + head_tail) / 2, (.17, .17, .20), skin, 'head')
for side in 'LR':
