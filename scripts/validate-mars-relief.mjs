...
assert.ok(cornDoc.materials.some(m=>m.name==='Corn golden kernels'));assert.ok(cornDoc.materials.some(m=>m.name==='Corn sunglasses'));assert.ok(cornDoc.materials.some(m=>m.name==='Corn fibrous husk'));
